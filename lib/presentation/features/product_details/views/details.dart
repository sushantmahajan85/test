...
class _ProductDetailsViewState extends State<ProductDetailsView> {
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                            itemBuilder: (context, index) => Padding(
                              ...
                              child: Image.network('https://images-na.ssl-images-amazon.com/images/I/31RMexpPDvL._AA260_.jpg')
                            ),
  ...
  Widget selectionOutlineButton(var deviceWidth, String alreadySelectedValue) {
          ...
          GestureDetector(
            ...
            child: Container(
              child: OpenFlutterProductRating(
                rating: 4.5,//widget.product.averageRating,
                ratingCount: 100,//widget.product.ratingCount,
