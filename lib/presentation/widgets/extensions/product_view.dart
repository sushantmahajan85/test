...
// extension View on Product {
  Widget getListView(
    ...
    return BaseProductListItem(
      ...
      inactiveMessage: true//amountAvailable == null || amountAvailable > 0
          ? null
      ...
      mainContentBuilder: (context) {
        return Column(
          ...
          children: <Widget>[
            Text('Deal Title', style: Theme.of(context).textTheme.display1),
            Text('Deal Subtitle', style: Theme.of(context).textTheme.body1),
            buildRating(context),
  ...
  Widget buildPrice(ThemeData _theme) {
    return Row(children: <Widget>[
      ...
      true ? buildDiscountPrice(_theme) : Container(),
    ]);
  }
  ...
  Widget buildDiscountPrice(ThemeData _theme) {
    return Text('\$' + 74.toStringAsFixed(0),
